...
import de.bixilon.kotlinglm.vec3.operators.op_Vec3l
...
class Vec3l(@JvmField var ofs: Int, @JvmField var array: LongArray) : Vec3t<Long>, ToBuffer {
    ...
    constructor(v: Vec1l) : this(v.x, v.x, v.x)
    constructor(x: Vec1l, y: Long, z: Long) : this(x.x, y, z)
    constructor(x: Long, y: Vec1l, z: Long) : this(x, y.x, z)
    constructor(x: Long, y: Long, z: Vec1l) : this(x, y, z.x)
    constructor(x: Vec1l, y: Vec1l, z: Vec1l) : this(x.x, y.x, z.x)

    constructor(xy: Vec2l, z: Long) : this(xy.x, xy.y, z)
    constructor(x: Long, yz: Vec2l) : this(x, yz.x, yz.y)
    ...
    operator fun plus(b: Vec3t<out Number>) = plus(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun plus(b: Vec3t<out Number>, res: Vec3l = Vec3l()) = plus(res, this, b._x.L, b._y.L, b._z.L)
    ...
    operator fun minus(b: Vec3t<out Number>) = minus(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun minus(b: Vec3t<out Number>, res: Vec3l = Vec3l()) = minus(res, this, b._x.L, b._y.L, b._z.L)
    ...
    operator fun times(b: Vec3t<out Number>) = times(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun times(b: Vec3t<out Number>, res: Vec3l = Vec3l()) = times(res, this, b._x.L, b._y.L, b._z.L)
    ...
    operator fun div(b: Vec3t<out Number>) = div(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun div(b: Vec3t<out Number>, res: Vec3l) = div(res, this, b._x.L, b._y.L, b._z.L)
    ...
    operator fun rem(b: Vec3t<out Number>) = rem(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun rem(b: Vec3t<out Number>, res: Vec3l) = rem(res, this, b._x.L, b._y.L, b._z.L)
    ...
    infix fun and(b: Vec3t<out Number>) = and(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun and(b: Vec3t<out Number>, res: Vec3l) = and(res, this, b._x.L, b._y.L, b._z.L)
    ...
    infix fun or(b: Vec3t<out Number>) = or(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun or(b: Vec3t<out Number>, res: Vec3l) = or(res, this, b._x.L, b._y.L, b._z.L)
    ...
    infix fun xor(b: Vec3t<out Number>) = xor(Vec3l(), this, b._x.L, b._y.L, b._z.L)
    ...
    fun xor(b: Vec3t<out Number>, res: Vec3l) = xor(res, this, b._x.L, b._y.L, b._z.L)
    ...
    infix fun shl(b: Vec3t<out Number>) = shl(Vec3l(), this, b._x.L, b._y.L, b._z.L)

    infix fun shlAssign(b: Number) = shl(this, this, b.L, b.L, b.L)
    infix fun shlAssign(b: Vec3t<out Number>) = shl(this, this, b._x.L, b._y.L, b._z.L)

    fun shl(b: Number, res: Vec3l) = shl(res, this, b.L, b.L, b.L)
    fun shl(b: Vec3t<out Number>, res: Vec3l) = shl(res, this, b._x.L, b._y.L, b._z.L)
    ...
    infix fun shr(b: Vec3t<out Number>) = shr(Vec3l(), this, b._x.L, b._y.L, b._z.L)

    infix fun shrAssign(b: Number) = shr(this, this, b.L, b.L, b.L)
    infix fun shrAssign(b: Vec3t<out Number>) = shr(this, this, b._x.L, b._y.L, b._z.L)

    fun shr(b: Number, res: Vec3l) = shr(res, this, b.L, b.L, b.L)
    fun shr(b: Vec3t<out Number>, res: Vec3l) = shr(res, this, b._x.L, b._y.L, b._z.L)
