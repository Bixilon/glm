...
import de.bixilon.kotlinglm.mat4x4.Mat4.Companion.div
import de.bixilon.kotlinglm.mat4x4.Mat4.Companion.minus
import de.bixilon.kotlinglm.mat4x4.Mat4.Companion.plus
import de.bixilon.kotlinglm.mat4x4.Mat4.Companion.times
import de.bixilon.kotlinglm.vec4.Vec4
import de.bixilon.kotlinglm.vec4.Vec4.Companion.div
import de.bixilon.kotlinglm.vec4.Vec4.Companion.minus
import de.bixilon.kotlinglm.vec4.Vec4.Companion.plus
import de.bixilon.kotlinglm.vec4.Vec4.Companion.times
...
interface op_Mat4 {
    ...
    /** Mat4 = Mat4 + Mat4 */
    fun plus(res: Mat4, a: Mat4, b: Mat4) = plus(res, a,
    ...
    /** Mat4 = Mat4 + Mat4 */
    fun plus(res: Mat4, a: Mat4, b0: Vec4, b1: Vec4, b2: Vec4, b3: Vec4) = plus(res, a,
            b0[0], b0[1], b0[2], b0[3],
            b1[0], b1[1], b1[2], b1[3],
            b2[0], b2[1], b2[2], b2[3],
            b3[0], b3[1], b3[2], b3[3])
    ...
    /** Mat4 = Mat4 - Mat4 */
    fun minus(res: Mat4, a: Mat4, b: Mat4) = minus(res, a,
            b[0, 0], b[0, 1], b[0, 2], b[0, 3],
            b[1, 0], b[1, 1], b[1, 2], b[1, 3],
            b[2, 0], b[2, 1], b[2, 2], b[2, 3],
            b[3, 0], b[3, 1], b[3, 2], b[3, 3])
    ...
    /** Mat4 = Mat4 - Mat4 */
    fun minus(res: Mat4, a: Mat4, b0: Vec4, b1: Vec4, b2: Vec4, b3: Vec4) = minus(res, a,
            b0[0], b0[1], b0[2], b0[3],
            b1[0], b1[1], b1[2], b1[3],
            b2[0], b2[1], b2[2], b2[3],
            b3[0], b3[1], b3[2], b3[3])
    ...
    /** Mat4 = Mat4 - Mat4 */
    fun minus(res: Mat4, a0: Vec4, a1: Vec4, a2: Vec4, a3: Vec4, b: Mat4) = minus(res,
            a0[0], a0[1], a0[2], a0[3],
            a1[0], a1[1], a1[2], a1[3],
            a2[0], a2[1], a2[2], a2[3],
    ...
    fun times(res: Vec4, a: Mat4, b: Vec4) = times(res, a, b.x, b.y, b.z, b.w)

    /** Vec4 col = Mat4 * Vec4 row */
    fun times(res: Vec4, a: Mat4, b0: Float, b1: Float, b2: Float, b3: Float): Vec4 {
    ...
    fun times(res: Vec4, a: Vec4, b: Mat4) = times(res, a.x, a.y, a.z, a.w, b)

    /** Vec4 row = Vec4 col * Mat4  */
    fun times(res: Vec4, a0: Float, a1: Float, a2: Float, a3: Float, b: Mat4): Vec4 {
    ...
    fun times(res: Mat4, a: Mat4, b: Mat4): Mat4 {
        ...
        ra[4] = var19 * var7 + var20 * var8 + var21 * var9 + var22 * var10
        ra[8] = var19 * var11 + var20 * var12 + var21 * var13 + var22 * var14
        ra[12] = var19 * var15 + var20 * var16 + var21 * var17 + var22 * var18
        var19 = aa[1]
        var20 = aa[5]
        var21 = aa[9]
        var22 = aa[13]
        ra[1] = var19 * var3 + var20 * var4 + var21 * var5 + var22 * var6
        ra[5] = var19 * var7 + var20 * var8 + var21 * var9 + var22 * var10
        ra[9] = var19 * var11 + var20 * var12 + var21 * var13 + var22 * var14
        ra[13] = var19 * var15 + var20 * var16 + var21 * var17 + var22 * var18
        var19 = aa[2]
        var20 = aa[6]
        var21 = aa[10]
        var22 = aa[14]
        ra[2] = var19 * var3 + var20 * var4 + var21 * var5 + var22 * var6
        ra[6] = var19 * var7 + var20 * var8 + var21 * var9 + var22 * var10
        ra[10] = var19 * var11 + var20 * var12 + var21 * var13 + var22 * var14
        ra[14] = var19 * var15 + var20 * var16 + var21 * var17 + var22 * var18
        var19 = aa[3]
        var20 = aa[7]
        var21 = aa[11]
        var22 = aa[15]
        ra[3] = var19 * var3 + var20 * var4 + var21 * var5 + var22 * var6
        ra[7] = var19 * var7 + var20 * var8 + var21 * var9 + var22 * var10
        ra[11] = var19 * var11 + var20 * var12 + var21 * var13 + var22 * var14
        ra[15] = var19 * var15 + var20 * var16 + var21 * var17 + var22 * var18

        return res
    }

    /** Mat4 = Mat4 * Mat4 */
    fun times(res: Mat4, a: Mat4, b0: Vec4, b1: Vec4, b2: Vec4, b3: Vec4) = times(res, a,
            b0[0], b0[1], b0[2], b0[3],
            b1[0], b1[1], b1[2], b1[3],
            b2[0], b2[1], b2[2], b2[3],
            b3[0], b3[1], b3[2], b3[3])
    ...
    /** Mat24 = Mat4 * Mat24 */
    fun times(res: Mat2x4, a: Mat4, b: Mat2x4) = times(res, a, b[0], b[1])

    /** Mat24 = Mat4 * Mat24 */
    fun times(res: Mat2x4, a: Mat4, b0: Vec4, b1: Vec4) = times(res, a, b0.x, b0.y, b0.z, b0.w, b1.x, b1.y, b1.z, b1.w)
    ...
    /** Mat34 = Mat4 * Mat34 */
    fun times(res: Mat3x4, a: Mat4, b: Mat3x4) = times(res, a, b[0], b[1], b[2], b[3])

    /** Mat34 = Mat4 * Mat34 */
    fun times(res: Mat3x4, a: Mat4, b0: Vec4, b1: Vec4, b2: Vec4, b3: Vec4) = times(res, a,
            b0.x, b0.y, b0.z,
            b1.x, b1.y, b1.z,
            b2.x, b2.y, b2.z,
            b3.x, b3.y, b3.z)
    ...
    fun div(res: Mat4, a: Mat4, b: Mat4) = div(res, a,
            b[0, 0], b[0, 1], b[0, 2], b[0, 3],
            b[1, 0], b[1, 1], b[1, 2], b[1, 3],
            b[2, 0], b[2, 1], b[2, 2], b[2, 3],
            b[3, 0], b[3, 1], b[3, 2], b[3, 3])
    ...
    /** Mat4 = Mat4 / Mat4 = Mat4 * Mat4^-1 */
    fun div(res: Mat4, a: Mat4, b0: Vec4, b1: Vec4, b2: Vec4, b3: Vec4) = div(res, a,
            b0[0], b0[1], b0[2], b0[3],
            b1[0], b1[1], b1[2], b1[3],
            b2[0], b2[1], b2[2], b2[3],
            b3[0], b3[1], b3[2], b3[3])
    ...
    /** Vec4 col = Mat4 * Vec4 row  */
    fun div(res: Vec4, a: Mat4, b: Vec4) = div(res, a, b.x, b.y, b.z, b.w)

    /** Vec4 col = Mat4 * Vec4 row  */
    fun div(res: Vec4, a: Mat4, b0: Float, b1: Float, b2: Float, b3: Float): Vec4 {
        // invert a
    ...
    /** Vec4 row = Vec4 col * Mat4  */
    fun div(res: Vec4, a: Vec4, b: Mat4) = div(res, a.x, a.y, a.z, a.w, b)

    /** Vec4 row = Vec4 col * Mat4  */
    fun div(res: Vec4, a0: Float, a1: Float, a2: Float, a3: Float, b: Mat4): Vec4 {
        // invert main.getB
