...
import de.bixilon.kotlinglm.vec2.operators.op_Vec2us
...
class Vec2us(@JvmField var ofs: Int, @JvmField var array: ShortArray) : Vec2t<Ushort>(), ToBuffer {
